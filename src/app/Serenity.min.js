!function() {
    ...
    function Controller($scope, CountdownService) {
        ...
        $scope.setCountdownTimer = CountdownService.setCountdownTimer, initialize();
    }
    ...
    function Service($interval) {
        ...
        function updateCounter() {
            if (countdown.counting) {
                ...
                countdown.timeRemainingInMs - differenceInMs <= 0 ? (self.stopCountdown(), countdown.timeRemainingInMs = 0) : (countdown.timeRemainingInMs -= differenceInMs, 
        ...
        self.getCountdown = function() {
            ...
            countdown.counting || self.resetCountdown();
